...
public class RandomEvent {
    ...
    static int eventFourCounter = 0; // event 4 has staged occurences that happen in a certain order. This value regulates this

    // constructor
    public RandomEvent(String characterType){
        this.characterType = characterType;
    }
        
    public int Nothing(int totalGold){ 
        
        // if no event or fight occurs, then a random sentence is displayed
        int gainedGold = 0;
    ...
    public int Encounter(int totalGold, int totalHealth){
